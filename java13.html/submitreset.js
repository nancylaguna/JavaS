...
function inic() {
    ...
    miFormulario.addEventListener("submit", function(){ return confirm("¿Seguro que desea enviar el formulario?");
    }, false);
    miFormulario.addEventListener("reset", function(){ return confirm("¿Seguro que desea reiniciar el formulario?");
}, false);
}
